...
def load_g():
    features_list,labels, train_val_test_idx, rdf = process.load_DOUBAN_data(
        train_val_test_dir='/train_val_test_idx_past.npz')
    features_list = [torch.FloatTensor(features).to(device) for features in features_list]
    features_list_img = process.load_DOUBAN_Img_data()
